...
#define RTK_NOR_FLASH_XIP_BASE      0x704D1000UL    /* FIXME: set to actual base */

// #define MOUNT_DB_SIZE  (0x0240f400u + 0x00998000u - MOUNT_DB)
#define RTK_NOR_FLASH_TOTAL_SIZE    (8UL * 1024 * 1024)   /* 10 MB total flash */
 ...
 * ────────────────────────────────────────────────────────────── */
#define FDB_REGION_OFFSET           (0x180000UL - 0x1000UL)     /* FIXME: adjust to your layout */

#define FDB_KVDB_SIZE               (256UL  * 1024)           /* 256 KB for KV + BF directory */
#define FDB_BF_DATA_SIZE            ((0x100000UL ))           /* ~2 MB for big-file data   */
