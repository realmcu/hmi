...
| [chsc6417_example.c](chsc6417_example.c) | Touch (CHSC6417) | 配置 → 读触摸点（100ms INT 超时） |
| [cst816d_example.c](cst816d_example.c) | Touch (CST816D) | 配置 → 读触摸点（release_ms 内无 INT 视为释放） |
