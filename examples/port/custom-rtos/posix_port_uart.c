...
{
    (void)drv_data;
    ((uart_file_t *)file_priv)->in_use = false;
    return POSIX_OK;
}
                               ...
                               void *buf, size_t count)
{
    ...
    /* 任务上下文阻塞读 */
    /* return hw_uart_read(d->reg_base, buf, count); */
    (void)f; (void)d; (void)buf; (void)count;
