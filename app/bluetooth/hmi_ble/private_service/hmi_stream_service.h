...
/* Characteristic UUIDs (16-bit, vendor specific; continue ctrl svc 0xFFC1~0xFFC3).
 * Deliberately in 0xFFCx to avoid the Realtek OTA/DFU service's 0xFFD0~0xFFD4
 * (app/ota/ota_service.h) -- overlapping there mis-routes writes to OTA. */
#define BLE_UUID_HMI_STREAM_RX          0xFFC4  /* Write(no rsp): peer -> device, KS_FRAME      */
#define BLE_UUID_HMI_STREAM_TX          0xFFC5  /* Notify: device -> peer, KS_ACK/CREDIT/REPORT */

/*============================================================================*
 *                              Types
 *============================================================================*/

/* RX sink: invoked in BLE callback context when the peer writes to 0xFFC4.
...
/* CCCD callback: peer enabled/disabled notifications on 0xFFC5. */
...
/* Send a notification (KS_ACK/KS_CREDIT/KS_REPORT) to the peer on 0xFFC5.
