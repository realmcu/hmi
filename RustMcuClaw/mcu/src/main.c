 ...
 *              bytes 1-32 : 16 rows x uint16_t big-endian,
...
#define UNIFONT_ENTRY_SIZE   33U           /* 1 + 16x2 */
...
/* = 12 + 65536x33 = 2 162 700 bytes, about 2.06 MB */
 ...
 *
 * Screen: 410 x 502 px, corner radius 80 px.
 ...
 * Usage (serial terminal):  kimi How is the weather today?
 */
...
static void display_draw_header(void)
{
    ...
    {
        /* Right-align: 8 chars x 8 px x scale 1 = 64 px */
 ...
 * follow-the-finger scroll: the display tracks the finger in
...
int main(void)
{
    ...
    /* ---- DHT11: read temperature and humidity once at power-on for verification ---- */
    {
