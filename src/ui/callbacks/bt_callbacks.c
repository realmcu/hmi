...
void bt_View_key_0_cb(void *obj, gui_event_t *e)
{
    ...
    {
        gui_view_switch_direct(gui_view_get_current(), "easy_demoMainView", SWITCH_INIT_STATE,
...
void bt_icon_timer_0_cb(void *obj)
{
    ...
    if (bt_icon_timer_cnt >= 200)
    {
        ...
        {
            gui_view_switch_direct(gui_view_get_current(), "qrcode_view", SWITCH_OUT_NONE_ANIMATION,
                                   SWITCH_IN_NONE_ANIMATION);
